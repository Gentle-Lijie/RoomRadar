...
<img src="https://p.ipic.vip/d714rb.png" alt="image-20260925203724343" style="zoom: 50%;" />
...
后来发现一个问题：学校除了 Scientia 里的普通教室，还有 `meetingroombooking.nottingham.edu.cn` 里的 Meeting Room。那当然也得一起查。
...
如果你对这个项目为什么会诞生感到好奇，可以亲自体验一下：

```text
http://timetablingunnc.nottingham.ac.uk:8017/room.htm
```
...
于是干脆自己写了一个。如果它顺便也帮你少点几次 Scientia，那挺好。
