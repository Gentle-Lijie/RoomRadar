  ...
  <div class="app-shell">
    ...
    <Tabs v-model="view" class="view-tabs">
      ...
      <TabsContent value="list" class="view-content">
        ...
        <div class="table-panel"><Table><TableHeader><TableRow><TableHead class="room-name-col">教室 / ID</TableHead><TableHead class="col-building">楼栋</TableHead><TableHead class="number-col">Capacity</TableHead><TableHead>当天预约</TableHead><TableHead>当天空闲时段</TableHead><TableHead class="number-col">区间预约数</TableHead></TableRow></TableHeader><TableBody>
          <TableRow v-for="room in visibleRooms" :key="room.id">
            ...
            <TableCell class="secondary-cell col-building">{{ room.building }}</TableCell><TableCell class="number-col capacity-number">{{ room.capacity }}</TableCell>
      ...
      <TabsContent value="matrix" class="view-content">
        ...
        <div v-if="matrixView === 'timeline'" class="timeline-pane">
          ...
          <div class="table-panel timeline-scroll" :style="{ '--tl-hours': Math.max(1, timelineHours.length) }"><Table><TableHeader><TableRow><TableHead class="timeline-room-col">教室 <span class="timeline-head-muted">/ 容量</span></TableHead><TableHead v-for="hour in timelineHours" :key="hour.start" colspan="2" class="timeline-hour-head">{{ hour.label }}</TableHead></TableRow></TableHeader><TableBody>
    ...
    <footer class="app-footer">Made with ❤️ by <a class="footer-link" href="https://github.com/Gentle-Lijie" target="_blank" rel="noopener noreferrer">GentleLijie</a><span class="footer-sep">·</span><a class="footer-link footer-github" href="https://github.com/Gentle-Lijie/RoomRadar" target="_blank" rel="noopener noreferrer" aria-label="GitHub 仓库"><svg viewBox="0 0 16 16" width="13" height="13" fill="currentColor" aria-hidden="true"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8Z"/></svg>GitHub</a></footer>
  </div>
</template>
